...
using PPWCode.Vernacular.NHibernate.II.Tests.IntegrationTests.Sync.QueryOver.DtoMapping.Repositories;
using PPWCode.Vernacular.NHibernate.II.Tests.Model.RepositoryWithDtoMapping;
using PPWCode.Vernacular.Persistence.III;

namespace PPWCode.Vernacular.NHibernate.II.Tests.IntegrationTests.Sync.QueryOver.DtoMapping
{
