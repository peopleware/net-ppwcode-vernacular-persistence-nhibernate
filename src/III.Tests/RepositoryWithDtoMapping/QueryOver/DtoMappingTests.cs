...
using PPWCode.Vernacular.NHibernate.III.Tests.RepositoryWithDtoMapping.QueryOver.Repositories;
using PPWCode.Vernacular.Persistence.IV;

namespace PPWCode.Vernacular.NHibernate.III.Tests.RepositoryWithDtoMapping.QueryOver
{
