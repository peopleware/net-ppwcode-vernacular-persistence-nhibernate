...
using PPWCode.Vernacular.NHibernate.III.Tests.BiDirectionalNoCascading.Repositories;
using PPWCode.Vernacular.NHibernate.III.Tests.IntegrationTests.QueryOver;

namespace PPWCode.Vernacular.NHibernate.III.Tests.BiDirectionalNoCascading
{
