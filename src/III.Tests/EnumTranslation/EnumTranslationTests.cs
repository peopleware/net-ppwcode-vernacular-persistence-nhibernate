...
using PPWCode.Vernacular.NHibernate.III.Tests.EnumTranslation.Models;
using PPWCode.Vernacular.NHibernate.III.Tests.EnumTranslation.Repositories;
using PPWCode.Vernacular.NHibernate.III.Tests.IntegrationTests.QueryOver;

namespace PPWCode.Vernacular.NHibernate.III.Tests.EnumTranslation
{
