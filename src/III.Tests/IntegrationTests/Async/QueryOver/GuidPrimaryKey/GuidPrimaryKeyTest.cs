...
using PPWCode.Vernacular.NHibernate.III.Tests.IntegrationTests.Async.QueryOver.GuidPrimaryKey.Repositories;
using PPWCode.Vernacular.NHibernate.III.Tests.Model.GuidPrimaryKey;

namespace PPWCode.Vernacular.NHibernate.III.Tests.IntegrationTests.Async.QueryOver.GuidPrimaryKey
{
