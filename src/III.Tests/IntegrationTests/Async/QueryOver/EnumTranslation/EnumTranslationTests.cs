...
using PPWCode.Vernacular.NHibernate.III.Tests.IntegrationTests.Async.QueryOver.EnumTranslation.Repositories;
using PPWCode.Vernacular.NHibernate.III.Tests.Model.EnumTranslation;

namespace PPWCode.Vernacular.NHibernate.III.Tests.IntegrationTests.Async.QueryOver.EnumTranslation
{
