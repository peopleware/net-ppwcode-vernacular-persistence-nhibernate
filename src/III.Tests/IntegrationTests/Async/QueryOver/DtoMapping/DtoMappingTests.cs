...
using PPWCode.Vernacular.NHibernate.III.Tests.IntegrationTests.Async.QueryOver.DtoMapping.Repositories;
using PPWCode.Vernacular.NHibernate.III.Tests.Model.RepositoryWithDtoMapping;
using PPWCode.Vernacular.Persistence.IV;

namespace PPWCode.Vernacular.NHibernate.III.Tests.IntegrationTests.Async.QueryOver.DtoMapping
{
