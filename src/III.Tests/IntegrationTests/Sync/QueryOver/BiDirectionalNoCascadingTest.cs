...
using PPWCode.Vernacular.NHibernate.III.Tests.IntegrationTests.Sync.QueryOver.Repositories;
using PPWCode.Vernacular.NHibernate.III.Tests.Models;

namespace PPWCode.Vernacular.NHibernate.III.Tests.IntegrationTests.Sync.QueryOver
{
